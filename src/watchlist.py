...
def setup_watchlist(instance):
    ...
    for clause in instance.clauses:
        # The clause watch its first literal
...
def update_watchlist(instance,
                     ...
                     verbose):
    """
    Updates the watch list after literal 'false_literal' assigned False, 
    by making any clause watching false_literal watch something else.
    If False returns a clause is contradicted by the current assignment.
    """
